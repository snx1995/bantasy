...
registerController("/auth", require("./controller/authority/authority"));
registerController("/", require("./controller/console"));
registerController("/article", require("./controller/article/article"));
registerController("/test", require("./controller/test"));
